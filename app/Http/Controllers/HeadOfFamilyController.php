...
class HeadOfFamilyController extends Controller
{
    ...
    public function store(HeadOfFamilyStoreRequest $request)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Kepala Keluaraga Berhasil Ditambahkan', new HeadOfFamilyResource($headOfFamily), 201);
        } catch (\Exception $e) {
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Kepala Keluaraga Berhasil Dihapus', null, 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
